...
class UpdateForm extends PureComponent {
  ...
  componentDidMount() {
    ...
    const categorySelect = categoryList.findIndex(item => item.id === curFood.category_id)
    const specs = curFood.specfoods ? curFood.specfoods.map(item => {return {
    ...
    const selectable = categoryList[categorySelect] || {}
  ...
  render() {
    ...
    const { specsFormVisible, categorySelect } = this.state
    const uploadButton = (
      <div>
